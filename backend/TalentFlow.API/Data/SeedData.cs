...
public static class SeedData
{
    ...
    public static void Seed(AppDbContext db)
    {
        ...
        {
            new() { Id = "t-demo-1", Name = "Zofia Malinowska", Initials = "ZM", RoleTitle = "Marketing & Komunikacja", Bio = "Pasjonatka digital marketingu i social media. Tworzę treści, które angażują i budują społeczności.", Age = 21, City = "Warszawa", Availability = Availability.Now, Interests = """["Social Media","Content Marketing","Grafika","Copywriting"]""", Industry = "Marketing" },
            new() { Id = "t-demo-2", Name = "Piotr Nowak", Initials = "PN", RoleTitle = "Frontend Developer", Bio = "Buduję interfejsy użytkownika z pasją do szczegółów. Zafascynowany React i nowoczesnym CSS.", Age = 22, City = "Kraków", Availability = Availability.Soon, Interests = """["React","TypeScript","CSS","UI/UX"]""", Industry = "IT & Technologie" },
            new() { Id = "t-3", Name = "Aleksandra Kowalczyk", Initials = "AK", RoleTitle = "Graphic Designer", Bio = "Projektuję identyfikacje wizualne i materiały reklamowe. Styl minimalistyczny to mój znak rozpoznawczy.", Age = 20, City = "Wrocław", Availability = Availability.Now, Interests = """["Branding","Ilustracja","Figma","Adobe Suite"]""", Industry = "Marketing" },
            new() { Id = "t-4", Name = "Michał Wiśniewski", Initials = "MW", RoleTitle = "Backend Developer", Bio = "Buduję skalowalne API i mikroserwisy. Lubię rozwiązywać złożone problemy algorytmiczne.", Age = 23, City = "Poznań", Availability = Availability.Busy, Interests = """["Python","Docker","Kubernetes","Bazy danych"]""", Industry = "IT & Technologie" },
            new() { Id = "t-5", Name = "Natalia Dąbrowska", Initials = "ND", RoleTitle = "UX Researcher", Bio = "Prowadzę badania użytkowników i tworzę personas. Wierzę, że dobry design zaczyna się od empatii.", Age = 21, City = "Gdańsk", Availability = Availability.Now, Interests = """["Badania UX","Prototypowanie","Psychologia","Figma"]""", Industry = "IT & Technologie" },
            new() { Id = "t-6", Name = "Bartosz Lewandowski", Initials = "BL", RoleTitle = "Data Analyst", Bio = "Analizuję dane i tworzę dashboardy. Pomagam firmom podejmować lepsze decyzje oparte na liczbach.", Age = 24, City = "Warszawa", Availability = Availability.Soon, Interests = """["Python","Power BI","SQL","Machine Learning"]""", Industry = "Finanse" },
            new() { Id = "t-7", Name = "Karolina Zielińska", Initials = "KZ", RoleTitle = "PR & Komunikacja", Bio = "Tworzę strategie komunikacyjne i zarządzam relacjami z mediami. Specjalizuję się w PR kryzysowym.", Age = 22, City = "Łódź", Availability = Availability.Now, Interests = """["PR","Media Relations","Copywriting","Event Marketing"]""", Industry = "Marketing" },
            new() { Id = "t-8", Name = "Dominik Szymański", Initials = "DS", RoleTitle = "Mobile Developer", Bio = "Tworzę aplikacje mobilne na iOS i Android. Pasjonat Flutter i natywnego development.", Age = 23, City = "Katowice", Availability = Availability.Now, Interests = """["Flutter","Swift","Kotlin","Mobile UX"]""", Industry = "IT & Technologie" },
            new() { Id = "t-9", Name = "Iga Kamińska", Initials = "IK", RoleTitle = "E-commerce Specialist", Bio = "Zarządzam sklepami internetowymi i optymalizuję konwersję. Specjalizuję się w SEO i płatnych kampaniach.", Age = 20, City = "Kraków", Availability = Availability.Soon, Interests = """["E-commerce","SEO","Google Ads","Analytics"]""", Industry = "E-commerce" },
        };
